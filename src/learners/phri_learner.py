...
class PHRILearner(object):
	...
	def learn_weights(self, traj, u_h: torch.Tensor, t):
		...
		print(f"Here is the update: {update}\n")
		print(f"Here are the old weights: {self.weights}\n")
		print(f"Here are the new weights: {curr_weight}\n")
	...
	def estimate_theta(self, update):
		...
		print(f"Here is weighted beta: {self.betas_u}\n")
